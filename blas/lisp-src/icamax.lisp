    ...
    (prog ((i 0) (ix 0) (smax 0.0) (icamax 0))
      ...
      (cond
       ((= incx 1)
        (setf smax
                (scabs1
                 (f2cl-lib:array-slice cx-%data% f2cl-lib:complex8 (1) ((1 *))
                                       cx-%offset%)))
        (f2cl-lib:fdo (i 2 (f2cl-lib:int-add i 1))
          ...
          (tagbody
            (cond
             ((>
               (scabs1 (f2cl-lib:array-slice cx f2cl-lib:complex8 (i) ((1 *))))
               smax)
              (setf icamax i)
              (setf smax
                      (scabs1
                       (f2cl-lib:array-slice cx-%data% f2cl-lib:complex8 (i)
                                             ((1 *)) cx-%offset%)))))
           label100000)))
       (t (setf ix 1)
        (setf smax
        ...
        (f2cl-lib:fdo (i 2 (f2cl-lib:int-add i 1))
          ...
          (tagbody
            (cond
             ((>
               (scabs1
                (f2cl-lib:array-slice cx f2cl-lib:complex8 (ix) ((1 *))))
               smax)
              (setf icamax i)
              (setf smax
                      (scabs1
                       (f2cl-lib:array-slice cx-%data% f2cl-lib:complex8 (ix)
                                             ((1 *)) cx-%offset%)))))
            (setf ix (f2cl-lib:int-add ix incx))
           label100001))))
      (go end_label)
