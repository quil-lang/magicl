...
(let* ((one (f2cl-lib:cmplx 1.0 0.0)) (zero (f2cl-lib:cmplx 0.0 0.0)))
  (declare (type (f2cl-lib:complex8) one)
           ...
           (ignorable one zero))
  (defun csyrk (uplo trans n k alpha a lda beta c ldc)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((upper nil) (i 0) (info 0) (j 0) (l 0) (nrowa 0)
        ...
        (go end_label)
       end_label
        (return (values uplo trans nil nil nil nil nil nil nil nil))))))

(in-package #-gcl #:cl-user #+gcl "CL-USER")
#+#.(cl:if (cl:find-package '#:f2cl) '(and) '(or))
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::csyrk fortran-to-lisp::*f2cl-function-info*)
