...
(let* ((one (f2cl-lib:cmplx 1.0 0.0)) (zero (f2cl-lib:cmplx 0.0 0.0)))
  (declare (type (f2cl-lib:complex8) one)
           ...
           (ignorable one zero))
  (defun cgemm (transa transb m n k alpha a lda b ldb$ beta c ldc)
    (declare (type (array f2cl-lib:complex8 (*)) c b a)
             (type (f2cl-lib:complex8) beta alpha)
             (type (f2cl-lib:integer4) ldc ldb$ lda k n m)
             (type (string *) transb transa))
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((conja nil) (conjb nil) (nota nil) (notb nil) (i 0) (info 0) (j 0)
             (l 0) (ncola 0) (nrowa 0) (nrowb 0) (temp #C(0.0 0.0)))
        (declare (type f2cl-lib:logical conja conjb nota notb)
       ...
       end_label
        (return
         (values transa transb nil nil nil nil nil nil nil nil nil nil nil))))))

(in-package #-gcl #:cl-user #+gcl "CL-USER")
#+#.(cl:if (cl:find-package '#:f2cl) '(and) '(or))
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::cgemm fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            ...
                                            '(fortran-to-lisp::transa
                                              fortran-to-lisp::transb nil nil
