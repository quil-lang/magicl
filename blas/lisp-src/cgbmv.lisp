...
(let* ((one (f2cl-lib:cmplx 1.0 0.0)) (zero (f2cl-lib:cmplx 0.0 0.0)))
  (declare (type (f2cl-lib:complex8) one)
           ...
           (ignorable one zero))
  (defun cgbmv (trans m n kl ku alpha a lda x incx beta y incy)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((noconj nil) (i 0) (info 0) (ix 0) (iy 0) (j 0) (jx 0) (jy 0)
       ...
       end_label
        (return
         (values trans nil nil nil nil nil nil nil nil nil nil nil nil))))))

(in-package #-gcl #:cl-user #+gcl "CL-USER")
#+#.(cl:if (cl:find-package '#:f2cl) '(and) '(or))
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::cgbmv fortran-to-lisp::*f2cl-function-info*)
