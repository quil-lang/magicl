...
(let* ((zero 0.0d0) (one 1.0d0) (two 2.0d0))
  ...
  (defun dtrsna
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((dummy (make-array 1 :element-type 'double-float)) (bignum 0.0d0)
             (cond$ 0.0d0) (cs 0.0d0) (delta 0.0d0) (dumm 0.0d0) (eps 0.0d0)
             (est 0.0d0) (lnrm 0.0d0) (mu 0.0d0) (prod 0.0d0) (prod1 0.0d0)
             (prod2 0.0d0) (rnrm 0.0d0) (scale 0.0d0) (smlnum 0.0d0) (sn 0.0d0)
             (i 0) (ierr 0) (ifst 0) (ilst 0) (j 0) (k 0) (kase 0) (ks 0)
             (n2 0) (nn 0) (pair nil) (somcon nil) (wantbh nil) (wants nil)
             (wantsp nil))
              ...
              (cond
               ...
               (t
                ...
                (setf (f2cl-lib:fref s-%data% ((f2cl-lib:int-add ks 1)) ((1 *))
                        ...
                        cond$)))))
            (cond
             (wantsp (dlacpy "F" n n t$ ldt work ldwork) (setf ifst k)
              (setf ilst 1)
              (multiple-value-bind
