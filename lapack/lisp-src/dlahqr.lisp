  ...
  (defun dlahqr (wantt wantz n ilo ihi h ldh wr wi iloz ihiz z ldz info)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((v (make-array 3 :element-type 'double-float))
             (work (make-array 1 :element-type 'double-float)) (ave 0.0d0)
             (cs 0.0d0) (disc 0.0d0) (h00 0.0d0) (h10 0.0d0) (h11 0.0d0)
             (h12 0.0d0) (h21 0.0d0) (h22 0.0d0) (h33 0.0d0) (h33s 0.0d0)
             (h43h34 0.0d0) (h44 0.0d0) (h44s 0.0d0) (ovfl 0.0d0) (s 0.0d0)
             (smlnum 0.0d0) (sn 0.0d0) (sum 0.0d0) (t1 0.0d0) (t2 0.0d0)
             (t3 0.0d0) (tst1 0.0d0) (ulp 0.0d0) (unfl 0.0d0) (v1 0.0d0)
             (v2 0.0d0) (v3 0.0d0) (i 0) (i1 0) (i2 0) (itn 0) (its 0) (j 0)
             (k 0) (l 0) (m 0) (nh 0) (nr 0) (nz 0))
