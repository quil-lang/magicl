...
(let* ((zero 0.0d0)
  ...
  (declare (type (double-float 0.0d0 0.0d0) zero)
           ...
           (type (double-float 0.01d0 0.01d0) hndrth)
           (type (double-float 10.0d0 10.0d0) ten)
           (type (double-float 100.0d0 100.0d0) hndrd)
           (type (double-float) meigth)
           (type (f2cl-lib:integer4 6 6) maxitr)
           (ignorable zero one negone hndrth ten hndrd meigth maxitr))
  (defun zbdsqr (uplo n ncvt nru ncc d e vt ldvt u ldu c ldc rwork info)
    (declare (type (array f2cl-lib:complex16 (*)) c u vt)
             (type (array double-float (*)) rwork e d)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((abse 0.0d0) (abss 0.0d0) (cosl 0.0d0) (cosr 0.0d0) (cs 0.0d0)
             (eps 0.0d0) (f 0.0d0) (g 0.0d0) (h 0.0d0) (mu 0.0d0) (oldcs 0.0d0)
             (oldsn 0.0d0) (r 0.0d0) (shift 0.0d0) (sigmn 0.0d0) (sigmx 0.0d0)
             (sinl 0.0d0) (sinr 0.0d0) (sll 0.0d0) (smax 0.0d0) (smin 0.0d0)
             (sminl 0.0d0) (sminoa 0.0d0) (sn 0.0d0) (thresh 0.0d0) (tol 0.0d0)
             (tolmul 0.0d0) (unfl 0.0d0) (i 0) (idir 0) (isub 0) (iter 0) (j 0)
             (ll 0) (lll 0) (m 0) (maxit 0) (nm1 0) (nm12 0) (nm13 0) (oldll 0)
             (oldm 0) (lower nil) (rotate nil))
        (declare
         (type (double-float) abse abss cosl cosr cs eps f g h mu oldcs oldsn r
          shift sigmn sigmx sinl sinr sll smax smin sminl sminoa sn thresh tol
          tolmul unfl)
        ...
        (cond ((and (not (lsame uplo "U")) (not lower)) (setf info -1))
              ...
              ((or (and (= ncc 0) (< ldc 1))
               ...
               (setf info -13)))
        (cond
         ((/= info 0) (xerbla "ZBDSQR" (f2cl-lib:int-sub info))
          (go end_label)))
        (if (= n 0)
            (go end_label))
        (if (= n 1)
            ...
            (tagbody
              ...
              (setf (f2cl-lib:fref d-%data% ((f2cl-lib:int-add i 1)) ((1 *))
                      ...
                      (* cs
                         (f2cl-lib:fref d-%data% ((f2cl-lib:int-add i 1))
                                        ((1 *)) d-%offset%)))
              (setf (f2cl-lib:fref rwork-%data% (i) ((1 *)) rwork-%offset%) cs)
              (setf (f2cl-lib:fref rwork-%data% ((f2cl-lib:int-add nm1 i))
                                   ((1 *)) rwork-%offset%)
                      sn)
             label10))
          (if (> nru 0)
              (zlasr "R" "V" "F" nru n
               (f2cl-lib:array-slice rwork-%data% double-float (1) ((1 *))
                                     rwork-%offset%)
               (f2cl-lib:array-slice rwork-%data% double-float (n) ((1 *))
                                     rwork-%offset%)
               u ldu))
          (if (> ncc 0)
              (zlasr "L" "V" "F" n ncc
       ...
       label90
        ...
        (cond
         ((= ll (f2cl-lib:int-add m (f2cl-lib:int-sub 1)))
          ...
          (if (> ncvt 0)
              (zdrot ncvt
               (f2cl-lib:array-slice vt-%data% f2cl-lib:complex16
                                     ((+ m (f2cl-lib:int-sub 1)) 1)
                                     ((1 ldvt) (1 *)) vt-%offset%)
               ldvt
               (f2cl-lib:array-slice vt-%data% f2cl-lib:complex16 (m 1)
                                     ((1 ldvt) (1 *)) vt-%offset%)
               ldvt cosr sinr))
          (if (> nru 0)
              (zdrot nru
               (f2cl-lib:array-slice u-%data% f2cl-lib:complex16
                                     ...
                                     u-%offset%)
               1
               (f2cl-lib:array-slice u-%data% f2cl-lib:complex16 (1 m)
                                     ((1 ldu) (1 *)) u-%offset%)
               1 cosl sinl))
          (if (> ncc 0)
              (zdrot ncc
               (f2cl-lib:array-slice c-%data% f2cl-lib:complex16
                                     ...
                                     ((1 ldc) (1 *)) c-%offset%)
               ldc
               (f2cl-lib:array-slice c-%data% f2cl-lib:complex16 (m 1)
                                     ((1 ldc) (1 *)) c-%offset%)
               ldc cosl sinl))
          ...
          (cond
           ((= idir 1) (setf cs one) (setf oldcs one)
            ...
            (setf (f2cl-lib:fref e-%data% ((f2cl-lib:int-sub m 1)) ((1 *))
                    ...
                    (* h oldsn))
            (if (> ncvt 0)
                (zlasr "L" "V" "F" (f2cl-lib:int-add (f2cl-lib:int-sub m ll) 1)
                 ncvt
                 (f2cl-lib:array-slice rwork-%data% double-float (1) ((1 *))
                                       rwork-%offset%)
                 (f2cl-lib:array-slice rwork-%data% double-float (n) ((1 *))
                                       rwork-%offset%)
                 (f2cl-lib:array-slice vt-%data% f2cl-lib:complex16 (ll 1)
                                       ((1 ldvt) (1 *)) vt-%offset%)
                 ldvt))
            (if (> nru 0)
                (zlasr "R" "V" "F" nru
                 (f2cl-lib:int-add (f2cl-lib:int-sub m ll) 1)
                 (f2cl-lib:array-slice rwork-%data% double-float ((+ nm12 1))
                                       ((1 *)) rwork-%offset%)
                 (f2cl-lib:array-slice rwork-%data% double-float ((+ nm13 1))
                                       ((1 *)) rwork-%offset%)
                 (f2cl-lib:array-slice u-%data% f2cl-lib:complex16 (1 ll)
                                       ((1 ldu) (1 *)) u-%offset%)
                 ldu))
            (if (> ncc 0)
                (zlasr "L" "V" "F" (f2cl-lib:int-add (f2cl-lib:int-sub m ll) 1)
                 ...
                 (f2cl-lib:array-slice rwork-%data% double-float ((+ nm13 1))
                                       ((1 *)) rwork-%offset%)
                 (f2cl-lib:array-slice c-%data% f2cl-lib:complex16 (ll 1)
                                       ((1 ldc) (1 *)) c-%offset%)
                 ldc))
            (if (<=
                 (abs
           ...
           (t (setf cs one) (setf oldcs one)
            (f2cl-lib:fdo (i m (f2cl-lib:int-add i (f2cl-lib:int-sub 1)))
              ...
              (tagbody
                ...
                (multiple-value-bind (var-0 var-1 var-2 var-3 var-4)
                  ...
                  (setf oldsn var-3)
                  (setf (f2cl-lib:fref d-%data% (i) ((1 *)) d-%offset%) var-4))
                (setf (f2cl-lib:fref rwork-%data% ((f2cl-lib:int-sub i ll))
                                     ((1 *)) rwork-%offset%)
                        cs)
                (setf (f2cl-lib:fref rwork-%data%
                                     ((f2cl-lib:int-add (f2cl-lib:int-sub i ll)
            ...
            (if (> ncvt 0)
                (zlasr "L" "V" "B" (f2cl-lib:int-add (f2cl-lib:int-sub m ll) 1)
                 ncvt
                 (f2cl-lib:array-slice rwork-%data% double-float ((+ nm12 1))
                                       ((1 *)) rwork-%offset%)
                 (f2cl-lib:array-slice rwork-%data% double-float ((+ nm13 1))
          ...
          (tagbody
            (cond
             ((< (f2cl-lib:fref d (i) ((1 *))) zero)
              ...
              (if (> ncvt 0)
                  (zdscal ncvt negone
                   (f2cl-lib:array-slice vt-%data% f2cl-lib:complex16 (i 1)
                                         ((1 ldvt) (1 *)) vt-%offset%)
                   ldvt))))
           label170))
        (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
          ...
          (tagbody
            ...
            (cond
             ((/= isub (f2cl-lib:int-add n 1 (f2cl-lib:int-sub i)))
              ...
              (if (> ncvt 0)
                  (zswap ncvt
                   (f2cl-lib:array-slice vt-%data% f2cl-lib:complex16 (isub 1)
                                         ((1 ldvt) (1 *)) vt-%offset%)
                   ldvt
                   (f2cl-lib:array-slice vt-%data% f2cl-lib:complex16
              ...
              (if (> nru 0)
                  (zswap nru
                   (f2cl-lib:array-slice u-%data% f2cl-lib:complex16 (1 isub)
                                         ((1 ldu) (1 *)) u-%offset%)
                   1
                   (f2cl-lib:array-slice u-%data% f2cl-lib:complex16
                                         (1
              ...
              (if (> ncc 0)
                  (zswap ncc
                   (f2cl-lib:array-slice c-%data% f2cl-lib:complex16 (isub 1)
                                         ((1 ldc) (1 *)) c-%offset%)
                   ldc
                   (f2cl-lib:array-slice c-%data% f2cl-lib:complex16
                                         ((+ n 1 (f2cl-lib:int-sub i)) 1)
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::zbdsqr
