  ...
  (defun dlaqtr (ltran lreal n t$ ldt b w scale x work info)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((d (make-array 4 :element-type 'double-float))
             (v (make-array 4 :element-type 'double-float)) (bignum 0.0d0)
             (eps 0.0d0) (rec 0.0d0) (scaloc 0.0d0) (si 0.0d0) (smin 0.0d0)
             (sminw 0.0d0) (smlnum 0.0d0) (sr 0.0d0) (tjj 0.0d0) (tmp 0.0d0)
             (xj 0.0d0) (xmax 0.0d0) (xnorm 0.0d0) (z 0.0d0) (i 0) (ierr 0)
             (j 0) (j1 0) (j2 0) (jnext 0) (k 0) (n1 0) (n2 0) (notran nil))
