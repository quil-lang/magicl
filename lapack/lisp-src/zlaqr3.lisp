    ...
    (f2cl-lib:with-multi-array-data
      ...
      (labels ((cabs1 (cdum)
        ...
        (prog ((i 0) (ifst 0) (ilst 0) (info 0) (infqr 0) (j 0) (jw 0) (kcol 0)
               ...
               (cdum #C(0.0d0 0.0d0)) (s #C(0.0d0 0.0d0))
               (tau #C(0.0d0 0.0d0)))
          (declare
           (type (f2cl-lib:integer4) i ifst ilst info infqr j jw kcol kln knt
            ...
            (cond
             ((and (> ns 1) (/= s zero)) (zcopy ns v ldv work 1)
              ...
              (zlarf "L" ns jw work 1 (f2cl-lib:dconjg tau) t$ ldt
               (f2cl-lib:array-slice work-%data% f2cl-lib:complex16 ((+ jw 1))
                                     ((1 *)) work-%offset%))
