...
(let* ((zero 0.0d0) (one 1.0d0))
  ...
  (defun dtrevc (side howmny select n t$ ldt vl ldvl vr ldvr mm m work info)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((x (make-array 4 :element-type 'double-float)) (beta 0.0d0)
             (bignum 0.0d0) (emax 0.0d0) (ovfl 0.0d0) (rec 0.0d0) (remax 0.0d0)
             (scale 0.0d0) (smin 0.0d0) (smlnum 0.0d0) (ulp 0.0d0) (unfl 0.0d0)
             (vcrit 0.0d0) (vmax 0.0d0) (wi 0.0d0) (wr 0.0d0) (xnorm 0.0d0)
             (i 0) (ierr 0) (ii 0) (ip 0) (is 0) (j 0) (j1 0) (j2 0) (jnxt 0)
             (k 0) (ki 0) (n2 0) (allv nil) (bothv nil) (leftv nil) (over nil)
