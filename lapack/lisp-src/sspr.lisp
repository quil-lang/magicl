...
(let* ((zero 0.0))
  (declare (type (single-float 0.0 0.0) zero)
           (ignorable zero))
  (defun sspr (uplo n alpha x incx ap)
    (declare (type (array single-float (*)) ap x)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((i 0) (info 0) (ix 0) (j 0) (jx 0) (k 0) (kk 0) (kx 0) (temp 0.0))
        ...
        (cond ((/= info 0) (xerbla "SSPR  " info) (go end_label)))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::sspr fortran-to-lisp::*f2cl-function-info*)
