  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((i 0) (ix 0) (iy 0) (m 0) (mp1 0))
      ...
      (if (= sa 0.0)
          (go end_label))
      (cond
       ((and (= incx 1) (= incy 1)) (setf m (mod n 4))
        (cond
         ((/= m 0)
        ...
        (f2cl-lib:fdo (i mp1 (f2cl-lib:int-add i 4))
          ...
          (tagbody
            ...
            (setf (f2cl-lib:fref sy-%data% ((f2cl-lib:int-add i 3)) ((1 *))
                                 sy-%offset%)
                    (+
                     (f2cl-lib:fref sy-%data% ((f2cl-lib:int-add i 3)) ((1 *))
                                    sy-%offset%)
                     (* sa
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::saxpy fortran-to-lisp::*f2cl-function-info*)
