  ...
  (defun dlasd4 (n i d z delta rho sigma work info)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((dd (make-array 3 :element-type 'double-float))
             (zz (make-array 3 :element-type 'double-float)) (a 0.0d0)
             (b 0.0d0) (c 0.0d0) (delsq 0.0d0) (delsq2 0.0d0) (dphi 0.0d0)
             (dpsi 0.0d0) (dtiim 0.0d0) (dtiip 0.0d0) (dtipsq 0.0d0)
             (dtisq 0.0d0) (dtnsq 0.0d0) (dtnsq1 0.0d0) (dw 0.0d0) (eps 0.0d0)
             (erretm 0.0d0) (eta 0.0d0) (phi 0.0d0) (prew 0.0d0) (psi 0.0d0)
             (rhoinv 0.0d0) (sg2lb 0.0d0) (sg2ub 0.0d0) (tau 0.0d0)
             (temp 0.0d0) (temp1 0.0d0) (temp2 0.0d0) (w 0.0d0) (ii 0) (iim1 0)
