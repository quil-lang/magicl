  ...
  (defun zungql (m n k a lda tau work lwork info)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((i 0) (ib 0) (iinfo 0) (iws 0) (j 0) (kk 0) (l 0) (ldwork 0)
        ...
        (declare
         (type (f2cl-lib:integer4) i ib iinfo iws j kk l ldwork lwkopt nb nbmin
          nx)
        ...
        (cond
         ((= info 0)
          (cond ((= n 0) (setf lwkopt 1))
                (t (setf nb (ilaenv 1 "ZUNGQL" " " m n k -1))
          ...
          (cond
           ((and
            ...
            (setf info -8)))))
        (cond
         ((/= info 0) (xerbla "ZUNGQL" (f2cl-lib:int-sub info)) (go end_label))
         (lquery (go end_label)))
          ...
          (f2cl-lib:fdo (i (f2cl-lib:int-add k (f2cl-lib:int-sub kk) 1)
            ...
            (tagbody
              ...
              (f2cl-lib:fdo (j (f2cl-lib:int-add n (f2cl-lib:int-sub k) i)
                            ...
                            ((> j
                                (f2cl-lib:int-add n (f2cl-lib:int-sub k) i ib
                                                  (f2cl-lib:int-sub 1)))
                             nil)
                (tagbody
                  (f2cl-lib:fdo (l
                                 (f2cl-lib:int-add m (f2cl-lib:int-sub k) i ib)
