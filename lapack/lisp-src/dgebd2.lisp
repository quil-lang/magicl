         ...
         ((>= m n)
          (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
            ...
            (tagbody
              ...
              (setf (f2cl-lib:fref a-%data% (i i) ((1 lda) (1 *)) a-%offset%)
                      one)
              (dlarf "L" (f2cl-lib:int-add (f2cl-lib:int-sub m i) 1)
              ...
              (cond
               ((< i n)
                ...
                (setf (f2cl-lib:fref a-%data% (i (f2cl-lib:int-add i 1))
                                     ((1 lda) (1 *)) a-%offset%)
                        one)
                (dlarf "R" (f2cl-lib:int-sub m i) (f2cl-lib:int-sub n i)
                 (f2cl-lib:array-slice a-%data% double-float
              ...
              (cond
               ((< i m)
                ...
                (setf (f2cl-lib:fref a-%data% ((f2cl-lib:int-add i 1) i)
                                     ((1 lda) (1 *)) a-%offset%)
                        one)
                (dlarf "L" (f2cl-lib:int-sub m i) (f2cl-lib:int-sub n i)
