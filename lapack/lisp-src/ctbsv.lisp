...
(let* ((zero (f2cl-lib:cmplx 0.0 0.0)))
  (declare (type (f2cl-lib:complex8) zero)
           (ignorable zero))
  (defun ctbsv (uplo trans diag n k a lda x incx)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((noconj nil) (nounit nil) (i 0) (info 0) (ix 0) (j 0) (jx 0)
        ...
        (cond
         ...
         ((= incx 0) (setf info 9)))
        (cond ((/= info 0) (xerbla "CTBSV " info) (go end_label)))
        (if (= n 0)
            (go end_label))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::ctbsv fortran-to-lisp::*f2cl-function-info*)
