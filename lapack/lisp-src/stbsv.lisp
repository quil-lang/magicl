...
(let* ((zero 0.0))
  (declare (type (single-float 0.0 0.0) zero)
           (ignorable zero))
  (defun stbsv (uplo trans diag n k a lda x incx)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((nounit nil) (i 0) (info 0) (ix 0) (j 0) (jx 0) (kplus1 0) (kx 0)
        ...
        (cond
         ...
         ((= incx 0) (setf info 9)))
        (cond ((/= info 0) (xerbla "STBSV " info) (go end_label)))
        (if (= n 0)
            (go end_label))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::stbsv fortran-to-lisp::*f2cl-function-info*)
