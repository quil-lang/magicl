...
(let* ((one 1.0) (zero 0.0))
  (declare (type (single-float 1.0 1.0) one)
           ...
           (ignorable one zero))
  (defun ssymv (uplo n alpha a lda x incx beta y incy)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((i 0) (info 0) (ix 0) (iy 0) (j 0) (jx 0) (jy 0) (kx 0) (ky 0)
        ...
        (cond ((/= info 0) (xerbla "SSYMV " info) (go end_label)))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::ssymv fortran-to-lisp::*f2cl-function-info*)
