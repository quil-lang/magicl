          ...
          (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
            ...
            (tagbody
              (setf (f2cl-lib:fref sx-%data% (i) ((1 *)) sx-%offset%)
                      (* sa (f2cl-lib:fref sx-%data% (i) ((1 *)) sx-%offset%)))
             label100000))
          (if (< n 5)
              (go end_label))))
            ...
            (setf (f2cl-lib:fref sx-%data% ((f2cl-lib:int-add i 2)) ((1 *))
                    ...
                    (* sa
                       (f2cl-lib:fref sx-%data% ((f2cl-lib:int-add i 2))
                                      ((1 *)) sx-%offset%)))
            (setf (f2cl-lib:fref sx-%data% ((f2cl-lib:int-add i 3)) ((1 *))
                                 sx-%offset%)
                    (* sa
                       (f2cl-lib:fref sx-%data% ((f2cl-lib:int-add i 3))
                                      ((1 *)) sx-%offset%)))
            (setf (f2cl-lib:fref sx-%data% ((f2cl-lib:int-add i 4)) ((1 *))
                                 sx-%offset%)
                    (* sa
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::sscal fortran-to-lisp::*f2cl-function-info*)
