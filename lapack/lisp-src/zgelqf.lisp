...
(defun zgelqf (m n a lda tau work lwork info)
    ...
    (prog ((i 0) (ib 0) (iinfo 0) (iws 0) (k 0) (ldwork 0) (lwkopt 0) (nb 0)
      ...
      (declare (type f2cl-lib:logical lquery)
               (type (f2cl-lib:integer4) nx nbmin nb lwkopt ldwork k iws iinfo
                ib i))
      (setf info 0)
      (setf nb (ilaenv 1 "ZGELQF" " " m n -1 -1))
      ...
      (cond ((< m 0) (setf info -1)) ((< n 0) (setf info -2))
            ...
            ((and
             ...
             (setf info -7)))
      (cond
       ((/= info 0) (xerbla "ZGELQF" (f2cl-lib:int-sub info)) (go end_label))
       (lquery (go end_label)))
        ...
        (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i nb))
          ...
          (tagbody
            ...
            (multiple-value-bind (var-0 var-1 var-2 var-3 var-4 var-5 var-6)
                (zgelq2 ib (f2cl-lib:int-add (f2cl-lib:int-sub n i) 1)
      ...
      (if (<= i k)
          (multiple-value-bind (var-0 var-1 var-2 var-3 var-4 var-5 var-6)
              (zgelq2 (f2cl-lib:int-add (f2cl-lib:int-sub m i) 1)
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::zgelqf
