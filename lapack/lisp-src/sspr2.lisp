...
(let* ((zero 0.0))
  (declare (type (single-float 0.0 0.0) zero)
           (ignorable zero))
  (defun sspr2 (uplo n alpha x incx y incy ap)
    (declare (type (array single-float (*)) ap y x)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((i 0) (info 0) (ix 0) (iy 0) (j 0) (jx 0) (jy 0) (k 0) (kk 0)
        ...
        (cond
         ...
         ((= incy 0) (setf info 7)))
        (cond ((/= info 0) (xerbla "SSPR2 " info) (go end_label)))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::sspr2 fortran-to-lisp::*f2cl-function-info*)
