...
(defun zdrot (n cx incx cy incy c s)
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((ctemp #C(0.0d0 0.0d0)) (i 0) (ix 0) (iy 0))
      (declare (type (f2cl-lib:integer4) iy ix i)
               (type (f2cl-lib:complex16) ctemp))
      (if (<= n 0)
          (go end_label))
      (cond
       ((and (= incx 1) (= incy 1))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::zdrot fortran-to-lisp::*f2cl-function-info*)
