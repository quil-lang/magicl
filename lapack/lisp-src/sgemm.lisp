...
(let* ((one 1.0) (zero 0.0))
  (declare (type (single-float 1.0 1.0) one)
           ...
           (ignorable one zero))
  (defun sgemm (transa transb m n k alpha a lda b ldb$ beta c ldc)
      ...
      (prog ((nota nil) (notb nil) (i 0) (info 0) (j 0) (l 0) (ncola 0)
        ...
        (cond
         ...
         ((< ldc (max (the f2cl-lib:integer4 1) (the f2cl-lib:integer4 m)))
          (setf info 13)))
        (cond ((/= info 0) (xerbla "SGEMM " info) (go end_label)))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::sgemm fortran-to-lisp::*f2cl-function-info*)
