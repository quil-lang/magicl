...
(let* ((zero 0.0d0) (one 1.0d0) (ten 10.0d0) (ldd 4) (ldx 2))
      ...
      (prog ((d
             ...
             (x
              (make-array (the fixnum (reduce #'* (list ldx 2))) :element-type
                          'double-float))
             (cs 0.0d0) (dnorm 0.0d0) (eps 0.0d0) (scale 0.0d0) (smlnum 0.0d0)
             (sn 0.0d0) (t11 0.0d0) (t22 0.0d0) (t33 0.0d0) (tau 0.0d0)
             (tau1 0.0d0) (tau2 0.0d0) (temp 0.0d0) (thresh 0.0d0) (wi1 0.0d0)
             (wi2 0.0d0) (wr1 0.0d0) (wr2 0.0d0) (xnorm 0.0d0) (ierr 0) (j2 0)
             (j3 0) (j4 0) (k 0) (nd 0))
          ...
          (tagbody
            ...
            (dlacpy "F" nd nd
             (f2cl-lib:array-slice t$-%data% double-float (j1 j1)
                                   ((1 ldt) (1 *)) t$-%offset%)
             ldt d ldd)
            (setf dnorm (dlange "M" nd nd d ldd work))
            (setf eps (dlamch "P"))
