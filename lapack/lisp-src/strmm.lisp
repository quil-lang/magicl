...
(let* ((one 1.0) (zero 0.0))
  (declare (type (single-float 1.0 1.0) one)
           ...
           (ignorable one zero))
  (defun strmm (side uplo transa diag m n alpha a lda b ldb$)
      ...
      (prog ((lside nil) (nounit nil) (upper nil) (i 0) (info 0) (j 0) (k 0)
        ...
        (cond ((and (not lside) (not (lsame side "R"))) (setf info 1))
              ...
              ((< ldb$
               ...
               (setf info 11)))
        (cond ((/= info 0) (xerbla "STRMM " info) (go end_label)))
        (if (or (= m 0) (= n 0))
            (go end_label))
        (cond
         ((= alpha zero)
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::strmm fortran-to-lisp::*f2cl-function-info*)
