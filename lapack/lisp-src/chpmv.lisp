...
(let* ((one (f2cl-lib:cmplx 1.0 0.0)) (zero (f2cl-lib:cmplx 0.0 0.0)))
  (declare (type (f2cl-lib:complex8) one)
           ...
           (ignorable one zero))
  (defun chpmv (uplo n alpha ap x incx beta y incy)
    (declare (type (array f2cl-lib:complex8 (*)) y x ap)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((i 0) (info 0) (ix 0) (iy 0) (j 0) (jx 0) (jy 0) (k 0) (kk 0)
        ...
        (cond
         ...
         ((= incy 0) (setf info 9)))
        (cond ((/= info 0) (xerbla "CHPMV " info) (go end_label)))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::chpmv fortran-to-lisp::*f2cl-function-info*)
