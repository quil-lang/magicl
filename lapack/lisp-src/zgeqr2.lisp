...
(let* ((one (f2cl-lib:cmplx 1.0d0 0.0d0)))
  (declare (type (f2cl-lib:complex16) one)
           (ignorable one))
  (defun zgeqr2 (m n a lda tau work info)
      ...
      (prog ((alpha #C(0.0d0 0.0d0)) (i 0) (k 0))
        ...
        (cond ((< m 0) (setf info -1)) ((< n 0) (setf info -2))
              ((< lda
               ...
               (setf info -4)))
        (cond
         ((/= info 0) (xerbla "ZGEQR2" (f2cl-lib:int-sub info))
          (go end_label)))
        ...
        (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
          ...
          (tagbody
            (multiple-value-bind (var-0 var-1 var-2 var-3 var-4)
                (zlarfg (f2cl-lib:int-add (f2cl-lib:int-sub m i) 1)
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::zgeqr2
