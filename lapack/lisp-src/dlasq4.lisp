...
(let* ((cnst1 0.563d0)
       ...
       (two 2.0d0)
       (hundrd 100.0d0))
  (declare (type (double-float 0.563d0 0.563d0) cnst1)
           (type (double-float 1.01d0 1.01d0) cnst2)
           (type (double-float 1.05d0 1.05d0) cnst3)
           (type (double-float 0.25d0 0.25d0) qurtr)
           (type (double-float 0.333d0 0.333d0) third$)
  ...
  (let ((g zero))
    ...
    (defun dlasq4 (i0 n0 z pp n0in dmin dmin1 dmin2 dn dn1 dn2 tau ttype)
      ...
      (f2cl-lib:with-multi-array-data
        ...
        (prog ((a2 0.0d0) (b1 0.0d0) (b2 0.0d0) (gam 0.0d0) (gap1 0.0d0)
               (gap2 0.0d0) (s 0.0d0) (i4 0) (nn 0) (np 0))
