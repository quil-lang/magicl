...
(let* ((zero 0.0))
  (declare (type (single-float 0.0 0.0) zero)
           (ignorable zero))
  (defun stpsv (uplo trans diag n ap x incx)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((nounit nil) (i 0) (info 0) (ix 0) (j 0) (jx 0) (k 0) (kk 0)
        ...
        (cond ((/= info 0) (xerbla "STPSV " info) (go end_label)))
        (if (= n 0)
            (go end_label))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::stpsv fortran-to-lisp::*f2cl-function-info*)
