       ...
       ((and (= incx 1) (= incy 1))
        (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
          ...
          (tagbody
            ...
            (setf (f2cl-lib:fref cx-%data% (i) ((1 *)) cx-%offset%) ctemp)
           label100000)))
       (t (setf ix 1) (setf iy 1)
        ...
        (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
          ...
          (tagbody
            ...
            (setf (f2cl-lib:fref cx-%data% (ix) ((1 *)) cx-%offset%) ctemp)
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::csrot fortran-to-lisp::*f2cl-function-info*)
