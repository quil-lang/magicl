...
(let* ((zero 0.0d0) (one 1.0d0))
  ...
  (defun dgesvd (jobu jobvt m n a lda s u ldu vt ldvt work lwork info)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((dum (make-array 1 :element-type 'double-float)) (anrm 0.0d0)
             (bignum 0.0d0) (eps 0.0d0) (smlnum 0.0d0) (bdspac 0) (blk 0)
             (chunk 0) (i 0) (ie 0) (ierr 0) (ir 0) (iscl 0) (itau 0) (itaup 0)
       ...
       end_label
        (return
         (values nil nil m n nil nil nil nil nil nil nil nil nil info))))))
