...
(let* ((one 1.0) (zero 0.0))
  (declare (type (single-float 1.0 1.0) one)
           ...
           (ignorable one zero))
  (defun ssyr2k (uplo trans n k alpha a lda b ldb$ beta c ldc)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((upper nil) (i 0) (info 0) (j 0) (l 0) (nrowa 0) (temp1 0.0)
             (temp2 0.0))
        ...
        (cond ((and (not upper) (not (lsame uplo "L"))) (setf info 1))
              ...
              ((< ldc
               ...
               (setf info 12)))
        (cond ((/= info 0) (xerbla "SSYR2K" info) (go end_label)))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::ssyr2k
