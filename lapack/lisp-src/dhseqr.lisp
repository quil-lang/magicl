...
(let* ((zero 0.0d0)
  ...
  (declare (type (double-float 0.0d0 0.0d0) zero)
           ...
           (type (double-float 1.5d0 1.5d0) const)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((s
             ...
             (vv
              (make-array (f2cl-lib:int-add nsmax 1) :element-type
                          'double-float))
             (absw 0.0d0) (ovfl 0.0d0) (smlnum 0.0d0) (tau 0.0d0) (temp 0.0d0)
             (tst1 0.0d0) (ulp 0.0d0) (unfl 0.0d0) (i 0) (i1 0) (i2 0) (ierr 0)
             (ii 0) (itemp 0) (itn 0) (its 0) (j 0) (k 0) (l 0) (maxb 0) (nh 0)
             (nr 0) (ns 0) (nv 0) (initz nil) (lquery nil) (wantt nil)
             (wantz nil))
           ...
           label70
                 ...
                 ((>= (f2cl-lib:fref wi (j) ((1 *))) zero)
                  (cond
                   ((= (f2cl-lib:fref wi (j) ((1 *))) zero)
                    ...
                    (dgemv "N" (f2cl-lib:int-add nv 1) nv one
                     (f2cl-lib:array-slice h-%data% double-float (l l)
                                           ((1 ldh) (1 *)) h-%offset%)
                     ldh vv 1
                   ...
                   ((> (f2cl-lib:fref wi (j) ((1 *))) zero)
                    ...
                    (dgemv "N" (f2cl-lib:int-add nv 2) (f2cl-lib:int-add nv 1)
                     one
                     (f2cl-lib:array-slice h-%data% double-float (l l)
                                           ((1 ldh) (1 *)) h-%offset%)
                     ldh vv 1 temp v 1)
            ...
            (f2cl-lib:fdo (k l (f2cl-lib:int-add k 1))
              ...
              (tagbody
                ...
                (setf (f2cl-lib:fref v (1) ((1 (f2cl-lib:int-add nsmax 1))))
                        one)
                (dlarfx "L" nr (f2cl-lib:int-add (f2cl-lib:int-sub i2 k) 1) v
                 tau
