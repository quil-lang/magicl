...
(defun sdot (n sx incx sy incy)
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((i 0) (ix 0) (iy 0) (m 0) (mp1 0) (stemp 0.0) (sdot 0.0))
      (declare (type (single-float) sdot stemp)
      ...
      (if (<= n 0)
          (go end_label))
      (cond
       ((and (= incx 1) (= incy 1)) (setf m (mod n 5))
        (cond
         ((/= m 0)
              ...
              (setf stemp
                      (+ stemp
                         (* (f2cl-lib:fref sx-%data% (i) ((1 *)) sx-%offset%)
                            (f2cl-lib:fref sy-%data% (i) ((1 *))
                                           sy-%offset%))))
             label100000))
          (cond ((< n 5) (setf sdot stemp) (go end_label)))))
                    ...
                    (+ stemp
                       ...
                       (*
                        (f2cl-lib:fref sx-%data% ((f2cl-lib:int-add i 1))
                                       ((1 *)) sx-%offset%)
                        (f2cl-lib:fref sy-%data% ((f2cl-lib:int-add i 1))
                                       ((1 *)) sy-%offset%))
                       (*
                        (f2cl-lib:fref sx-%data% ((f2cl-lib:int-add i 2))
                                       ((1 *)) sx-%offset%)
                        (f2cl-lib:fref sy-%data% ((f2cl-lib:int-add i 2))
                                       ((1 *)) sy-%offset%))
                       (*
                        (f2cl-lib:fref sx-%data% ((f2cl-lib:int-add i 3))
                                       ((1 *)) sx-%offset%)
                        (f2cl-lib:fref sy-%data% ((f2cl-lib:int-add i 3))
                                       ((1 *)) sy-%offset%))
                       (*
                        (f2cl-lib:fref sx-%data% ((f2cl-lib:int-add i 4))
                                       ((1 *)) sx-%offset%)
                        (f2cl-lib:fref sy-%data% ((f2cl-lib:int-add i 4))
                                       ((1 *)) sy-%offset%))))
           label100001)))
      ...
      (go end_label)
     end_label
      (return (values sdot nil nil nil nil nil)))))

(in-package #-gcl #:cl-user #+gcl "CL-USER")
#+#.(cl:if (cl:find-package '#:f2cl) '(and) '(or))
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::sdot fortran-to-lisp::*f2cl-function-info*)
