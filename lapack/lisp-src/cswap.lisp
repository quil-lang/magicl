...
(defun cswap (n cx incx cy incy)
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((i 0) (ix 0) (iy 0) (ctemp #C(0.0 0.0)))
      (declare (type (f2cl-lib:complex8) ctemp)
      ...
      (cond
       ((and (= incx 1) (= incy 1))
        (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                      ((> i n) nil)
          (tagbody
            (setf ctemp (f2cl-lib:fref cx-%data% (i) ((1 *)) cx-%offset%))
            (setf (f2cl-lib:fref cx-%data% (i) ((1 *)) cx-%offset%)
                    (f2cl-lib:fref cy-%data% (i) ((1 *)) cy-%offset%))
            (setf (f2cl-lib:fref cy-%data% (i) ((1 *)) cy-%offset%) ctemp)
           label100000)))
       (t (setf ix 1) (setf iy 1)
        ...
        (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                      ((> i n) nil)
          (tagbody
            (setf ctemp (f2cl-lib:fref cx-%data% (ix) ((1 *)) cx-%offset%))
            (setf (f2cl-lib:fref cx-%data% (ix) ((1 *)) cx-%offset%)
                    (f2cl-lib:fref cy-%data% (iy) ((1 *)) cy-%offset%))
            (setf (f2cl-lib:fref cy-%data% (iy) ((1 *)) cy-%offset%) ctemp)
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::cswap fortran-to-lisp::*f2cl-function-info*)
