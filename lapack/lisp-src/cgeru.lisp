...
(let* ((zero (f2cl-lib:cmplx 0.0 0.0)))
  (declare (type (f2cl-lib:complex8) zero)
           (ignorable zero))
  (defun cgeru (m n alpha x incx y incy a lda)
      ...
      (prog ((i 0) (info 0) (ix 0) (j 0) (jy 0) (kx 0) (temp #C(0.0 0.0)))
        ...
        (cond ((< m 0) (setf info 1)) ((< n 0) (setf info 2))
              ...
              ((< lda
               ...
               (setf info 9)))
        (cond ((/= info 0) (xerbla "CGERU " info) (go end_label)))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::cgeru fortran-to-lisp::*f2cl-function-info*)
