...
(defun sswap (n sx incx sy incy)
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((i 0) (ix 0) (iy 0) (m 0) (mp1 0) (stemp 0.0))
      ...
      (cond
        ...
        (cond
         ((/= m 0)
          (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                        ((> i m) nil)
            (tagbody
              (setf stemp (f2cl-lib:fref sx-%data% (i) ((1 *)) sx-%offset%))
              (setf (f2cl-lib:fref sx-%data% (i) ((1 *)) sx-%offset%)
                      (f2cl-lib:fref sy-%data% (i) ((1 *)) sy-%offset%))
              (setf (f2cl-lib:fref sy-%data% (i) ((1 *)) sy-%offset%) stemp)
             label100000))
          (if (< n 3)
              (go end_label))))
          ...
          (tagbody
            ...
            (setf stemp
                    (f2cl-lib:fref sx-%data% ((f2cl-lib:int-add i 1)) ((1 *))
                                   sx-%offset%))
            (setf (f2cl-lib:fref sx-%data% ((f2cl-lib:int-add i 1)) ((1 *))
                                 sx-%offset%)
                    (f2cl-lib:fref sy-%data% ((f2cl-lib:int-add i 1)) ((1 *))
                                   sy-%offset%))
            ...
            (setf stemp
                    (f2cl-lib:fref sx-%data% ((f2cl-lib:int-add i 2)) ((1 *))
                                   sx-%offset%))
            (setf (f2cl-lib:fref sx-%data% ((f2cl-lib:int-add i 2)) ((1 *))
                                 sx-%offset%)
                    (f2cl-lib:fref sy-%data% ((f2cl-lib:int-add i 2)) ((1 *))
                                   sy-%offset%))
       ...
       (t (setf ix 1) (setf iy 1)
        ...
        (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                      ((> i n) nil)
          (tagbody
            (setf stemp (f2cl-lib:fref sx-%data% (ix) ((1 *)) sx-%offset%))
            (setf (f2cl-lib:fref sx-%data% (ix) ((1 *)) sx-%offset%)
                    (f2cl-lib:fref sy-%data% (iy) ((1 *)) sy-%offset%))
            (setf (f2cl-lib:fref sy-%data% (iy) ((1 *)) sy-%offset%) stemp)
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::sswap fortran-to-lisp::*f2cl-function-info*)
