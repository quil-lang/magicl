...
(let* ((zero 0.0))
  (declare (type (single-float 0.0 0.0) zero)
           (ignorable zero))
  (defun strmv (uplo trans diag n a lda x incx)
      ...
      (prog ((nounit nil) (i 0) (info 0) (ix 0) (j 0) (jx 0) (kx 0) (temp 0.0))
        ...
        (cond
         ...
         ((< lda (max (the f2cl-lib:integer4 1) (the f2cl-lib:integer4 n)))
          (setf info 6))
         ((= incx 0) (setf info 8)))
        (cond ((/= info 0) (xerbla "STRMV " info) (go end_label)))
        (if (= n 0)
            (go end_label))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::strmv fortran-to-lisp::*f2cl-function-info*)
