...
(let* ((zero 0.0))
  (declare (type (single-float 0.0 0.0) zero)
           (ignorable zero))
  (defun ssyr2 (uplo n alpha x incx y incy a lda)
    (declare (type (array single-float (*)) a y x)
      ...
      (prog ((i 0) (info 0) (ix 0) (iy 0) (j 0) (jx 0) (jy 0) (kx 0) (ky 0)
        ...
        (cond
         ...
         ((< lda (max (the f2cl-lib:integer4 1) (the f2cl-lib:integer4 n)))
          (setf info 9)))
        (cond ((/= info 0) (xerbla "SSYR2 " info) (go end_label)))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::ssyr2 fortran-to-lisp::*f2cl-function-info*)
