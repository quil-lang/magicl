...
(defun zlapmr (forwrd m n x ldx k)
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((temp #C(0.0d0 0.0d0)) (i 0) (in 0) (j 0) (jj 0))
      (declare (type (f2cl-lib:integer4) jj j in i)
          ...
          (tagbody
           ...
           label20
            ...
            (f2cl-lib:fdo (jj 1 (f2cl-lib:int-add jj 1))
              ...
              (tagbody
                (setf temp
                        (f2cl-lib:fref x-%data% (j jj) ((1 ldx) (1 *))
                                       x-%offset%))
                (setf (f2cl-lib:fref x-%data% (j jj) ((1 ldx) (1 *))
                                     x-%offset%)
                        (f2cl-lib:fref x-%data% (in jj) ((1 ldx) (1 *))
                                       x-%offset%))
                (setf (f2cl-lib:fref x-%data% (in jj) ((1 ldx) (1 *))
                                     x-%offset%)
                        temp)
               label30))
          ...
          (tagbody
           ...
           label60
            ...
            (f2cl-lib:fdo (jj 1 (f2cl-lib:int-add jj 1))
              ...
              (tagbody
                (setf temp
                        (f2cl-lib:fref x-%data% (i jj) ((1 ldx) (1 *))
                                       x-%offset%))
                (setf (f2cl-lib:fref x-%data% (i jj) ((1 ldx) (1 *))
                                     x-%offset%)
                        (f2cl-lib:fref x-%data% (j jj) ((1 ldx) (1 *))
                                       x-%offset%))
                (setf (f2cl-lib:fref x-%data% (j jj) ((1 ldx) (1 *))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::zlapmr
