...
(let* ((zero 0.0))
  (declare (type (single-float 0.0 0.0) zero)
           (ignorable zero))
  (defun stbmv (uplo trans diag n k a lda x incx)
    (declare (type (array single-float (*)) x a)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((nounit nil) (i 0) (info 0) (ix 0) (j 0) (jx 0) (kplus1 0) (kx 0)
        ...
        (cond
         ...
         ((= incx 0) (setf info 9)))
        (cond ((/= info 0) (xerbla "STBMV " info) (go end_label)))
        (if (= n 0)
            (go end_label))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::stbmv fortran-to-lisp::*f2cl-function-info*)
