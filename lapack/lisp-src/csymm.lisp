...
(let* ((one (f2cl-lib:cmplx 1.0 0.0)) (zero (f2cl-lib:cmplx 0.0 0.0)))
  (declare (type (f2cl-lib:complex8) one)
           ...
           (ignorable one zero))
  (defun csymm (side uplo m n alpha a lda b ldb$ beta c ldc)
      ...
      (prog ((upper nil) (i 0) (info 0) (j 0) (k 0) (nrowa 0)
        ...
        (cond
         ...
         ((< ldc (max (the f2cl-lib:integer4 1) (the f2cl-lib:integer4 m)))
          (setf info 12)))
        (cond ((/= info 0) (xerbla "CSYMM " info) (go end_label)))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::csymm fortran-to-lisp::*f2cl-function-info*)
