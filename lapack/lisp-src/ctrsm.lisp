...
(let* ((one (f2cl-lib:cmplx 1.0 0.0)) (zero (f2cl-lib:cmplx 0.0 0.0)))
  (declare (type (f2cl-lib:complex8) one)
           ...
           (ignorable one zero))
  (defun ctrsm (side uplo transa diag m n alpha a lda b ldb$)
      ...
      (prog ((lside nil) (noconj nil) (nounit nil) (upper nil) (i 0) (info 0)
        ...
        (cond ((and (not lside) (not (lsame side "R"))) (setf info 1))
              ...
              ((< ldb$
               ...
               (setf info 11)))
        (cond ((/= info 0) (xerbla "CTRSM " info) (go end_label)))
        (if (or (= m 0) (= n 0))
            (go end_label))
        (cond
         ((= alpha zero)
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::ctrsm fortran-to-lisp::*f2cl-function-info*)
