...
(let* ((zero 0.0d0) (one 1.0d0) (sclfac 8.0d0) (factor 0.95d0))
  (declare (type (double-float 0.0d0 0.0d0) zero)
           (type (double-float 1.0d0 1.0d0) one)
           (type (double-float 8.0d0 8.0d0) sclfac)
  ...
  (defun dgebal (job n a lda ilo ihi scale info)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((c 0.0d0) (ca 0.0d0) (f 0.0d0) (g 0.0d0) (r 0.0d0) (ra 0.0d0)
             (s 0.0d0) (sfmax1 0.0d0) (sfmax2 0.0d0) (sfmin1 0.0d0)
             (sfmin2 0.0d0) (i 0) (ica 0) (iexc 0) (ira 0) (j 0) (k 0) (l 0)
             (m 0) (noconv nil))
        (declare
