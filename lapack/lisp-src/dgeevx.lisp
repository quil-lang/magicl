...
(let* ((zero 0.0d0) (one 1.0d0))
  ...
  (defun dgeevx
    ...
    (declare (type (array f2cl-lib:integer4 (*)) iwork)
             ...
             (type (string 1) sense jobvr jobvl balanc))
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((dum (make-array 1 :element-type 'double-float))
             (select (make-array 1 :element-type 't)) (anrm 0.0d0)
             (bignum 0.0d0) (cs 0.0d0) (cscale 0.0d0) (eps 0.0d0) (r 0.0d0)
             (scl 0.0d0) (smlnum 0.0d0) (sn 0.0d0) (hswork 0) (i 0) (icond 0)
             (ierr 0) (itau 0) (iwrk 0) (k 0) (maxb 0) (maxwrk 0) (minwrk 0)
             (nout 0)
             (job
