...
(let* ((zero 0.0d0) (one 1.0d0) (two 2.0d0) (half 0.5d0) (eight 8.0d0))
    ...
    (defun dlasy2
      ...
      (f2cl-lib:with-multi-array-data
        ...
        (prog ((btmp (make-array 4 :element-type 'double-float))
               ...
               (bet 0.0d0) (eps 0.0d0) (gam 0.0d0) (l21 0.0d0) (sgn 0.0d0)
               (smin 0.0d0) (smlnum 0.0d0) (tau1 0.0d0) (temp 0.0d0)
               (u11 0.0d0) (u12 0.0d0) (u22 0.0d0) (xmax 0.0d0) (i 0) (ip 0)
               (ipiv 0) (ipsv 0) (j 0) (jp 0) (jpsv 0) (k 0) (bswap nil)
               (xswap nil))
